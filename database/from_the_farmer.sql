...
MySQL - 5.7.28-0ubuntu0.19.04.2 : Database - farmers
*********************************************************************
*/
...
insert  into `categories`(`id`,`category_random_id`,`category`,`deleted`) values (3,'5f5094640a247','test 1234',0),(4,'5f5094b2df0b6','test 786',1),(5,'5f52082bebf79','mac1',1),(6,'5f520844465fa','micro1',0),(17,'5f5727f272e97','',1),(18,'5f572ba25a0d5','',1),(19,'5f572e20167c2','micro',0),(20,'5f572e6f95382','hello',1),(23,'5f574b5f6d5f2','test',1),(24,'5f574cff3cedf','Qbd',1),(25,'5f586560ba3ae','test79',1),(26,'5f5874655e355','testeed',1),(27,'5f5874740b823','testeed',1),(28,'5f5875718cda3','testeedd',1),(29,'5f58757a8458d','testeed',1),(30,'5f5875ce4b2c7','testeed',1),(31,'5f5876018ae23','testeeds',1),(32,'5f58762ad4d51','$row',1),(33,'5f5877860831e','testeeds',1),(34,'5f7452010987c','qbd qms',0),(35,'5f74537d64630','qbd',0),(36,'5f7ff5ad09aad','test',0),(37,'5f841f37e9a7b','mini',1);
...
CREATE TABLE `company` (
  ...
  `company_random_id` varchar(255) COLLATE utf8_estonian_ci DEFAULT NULL,
  `company` varchar(255) COLLATE utf8_estonian_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8_estonian_ci DEFAULT NULL,
  `company_logo` text COLLATE utf8_estonian_ci,
  `contact_number` varchar(50) COLLATE utf8_estonian_ci DEFAULT NULL,
  `address` varchar(255) COLLATE utf8_estonian_ci DEFAULT NULL,
  `website` varchar(255) COLLATE utf8_estonian_ci DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT '0',
  `state` varchar(5) COLLATE utf8_estonian_ci DEFAULT NULL,
...
insert  into `company`(`company_id`,`company_random_id`,`company`,`email`,`company_logo`,`contact_number`,`address`,`website`,`deleted`,`state`,`city`) values (32,'5f69c9533a41d','microlent','microlent@gmail.com','2009042249_Image3.jpg','987456321','jodhpur','microlent.com',0,'ACT',85),(33,'5f69c96e13921','qbd','qbd@gmail.com','2009042257_Image4.jpg','7896354123','','qbd.com',0,'QLD',43),(34,'5f69cfaf22bfe','micro','micro@gmail.com','2009122447_Image4.jpg','789632145','','micro',0,'QLD',39),(37,'5f69d3dfa58b4','mac','mac@gmail.com','2009042217_Image1.jpg','852741960','jodhpur','mav',1,NULL,NULL),(38,'5f6b13ec7b462','test','test@gmail.com','2009022351_Image2.jpg','test','test','test',0,'TAS',61),(39,'5f6c6b3a13af0','google','shakirbhay786@gmail.com','2009032437_img03.jpg','7896541230','test','google.com',0,'TAS',60),(40,'5f7453f64c3a2','qwerty','qwerty@gmail.com','2009093030_Image7.jpg','9638527410','jodhpur','qwerty.com',0,'ACT',85),(41,'5f7ef0b39df86','qbds','qbds@gmail.com','2010100855_Image1.jpg','8527419630','jodhpur','qbds.com',0,'TAS',61),(42,'5f7ff6e0c6311','qa','qbds@gmail.com','2010050932_Image2.jpg','test','jodhpur','qbds.com',0,'NT',28),(43,'5f841f1a3e314','mini','mini@gmail.com','2010091214_img08.jpg','7963512789','nagaur','mini.com',0,'TAS',63);
...
insert  into `products`(`product_id`,`product_random_id`,`product`,`price`,`description`,`company_id`,`category_id`,`product_image`,`deleted`) values (1,'5f55d72d479f8','test',NULL,NULL,0,0,NULL,1),(2,'5f55d734ee1ef','test',NULL,NULL,0,0,NULL,1),(3,'5f55dfc560e86','test',NULL,NULL,0,0,NULL,1),(4,'5f55e03ba5555','testes','786','test',27,4,NULL,1),(5,'5f5868b5d1ac8','pineapple','test','tested',32,19,'product_img02.jpg',1),(6,'5f5868de34522','test','78','',33,6,'product_img01.jpg',0),(7,'5f586a0c25c87','test','test','',34,4,NULL,1),(8,'5f58786907ce8','test','test','',37,3,NULL,1),(9,'5f58787e86e10','test','test','',37,6,NULL,1),(10,'5f5878a405c7c','test','company','',34,6,NULL,1),(11,'5f5878c59504e','banana','55','test',39,19,'product_img07.jpg',0),(12,'5f6875e8c1c41','sugar','125','test',38,6,NULL,1),(13,'5f6988b3633a7','sugar','99','',38,6,'product_img07.jpg',0),(14,'5f6988d3b05f1','sugar','1234','',34,4,'product_img06.jpg',0),(15,'5f69893fb4206','test','test','',37,3,NULL,1),(16,'5f6d9761410f4','ilaychi','499','test',32,19,'product_img02.jpg',0),(17,'5f6d9f01b5cbe','wine','90','test',39,19,'product_img05.jpg',0),(18,'5f7479d467d46','Ghee','450','A1',32,34,'2009123004_img05.jpg',0);
